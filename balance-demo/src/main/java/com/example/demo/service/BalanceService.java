...
import com.example.demo.repo.BalanceItemRepo;
import com.example.demo.repo.BalanceRepo;
import com.example.demo.repo.UserRepo;
import com.example.demo.vo.BalanceReportVo;
...
public class BalanceService {
	...
	public Page<BalanceReportVo> searchReport(Type type, LocalDate dateFrom, LocalDate dateTo, Optional<Integer> page,
		...
		Specification<Balance> spec = (root, query, builder) -> builder.equal(root.get("user").get("loginId"), SecurityContextHolder.getContext().getAuthentication().getName());
